	...
	var mobileMenu = function() {
		if ( $(window).width() < 769 ) {
			...
			if ( $('#fh5co-mobile-menu').length < 1 ) {
				...
				$('#fh5co-logo-mobile-wrap').append('<a href="#" id="fh5co-mobile-menu-btn"><i class="ti-menu"></i></a> <a href="http://www.maesong24.com"><h1 id="fh5co-logo-mobile-logo" class="pull-left"> </h1></a>')
