...
<div class="content_04">
	<div class="content_04-1">
		<div class="title_month">
			<i class="fas fa-circle-notch"></i> 일성 2021년 10월 누적 Business Status
		</div>
