...
<div class="content_01">
	<div class="content_01-2 content01_infra_chunnon" >
		...
		<div class="tc mt50" style="font-size: 40px; color: #fff; font-weight: bold;">천안~논산고속도로</div>
...
<div class="content_50" style="background: url(resource/images/bg.jpg) no-repeat 0% 0;"> 
	...
	<div style="background: url(/resource/images/infra/main_chunnon.jpg) no-repeat 100% 0%;width: 100%; height: 1000px; background-size: 100%;"></div> 
...
<div class="content_04">
	 <div class="content_04-1">
		<div class="title_month">
			<i class="fas fa-circle-notch"></i> 천논고속도로 2021년 3월 누적 Business Status
		</div>
