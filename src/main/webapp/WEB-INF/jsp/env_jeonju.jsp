...
<div class="content_01">
	<div class="content_01-2 content01_env_jeonju" >
		<div class="tc mt100">
			<h1 class="wow flipInX" style="font-size: 30px; font-weight: bold; color: white; text-shadow: 3px 3px 3px #404040;">이도 에코 전주</h1>
		</div>
...
<div class="content_04">
	<div class="content_04-1">
		<div class="title_month">
			<i class="fas fa-circle-notch"></i> 이도 에코 전주 2022년 11월 누적 Business Status
		</div>
