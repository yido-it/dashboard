...
<div class="content_01">
	<div class="content_01-2 content01_infra_yongseo" > 
		<div class="tc mt50 wow flipInY" style="font-size: 40px; color: #fff; font-weight: bold;">용인~서울고속도로</div>
...
<div class="content_50" style="background: url(resource/images/bg.jpg) no-repeat 0% 0;"> 
	...
	<div class="wow fadeInUp" style="background: url(/resource/images/infra/main_yongseo.jpg) no-repeat 100% 0%;width: 100%; height: 1000px; background-size: 100%;"></div> 
...
<div class="content_04">
	 <div class="content_04-1">
		<div class="title_month">
			<i class="fas fa-circle-notch"></i> 용서고속도로 2021년 10월 누적 Business Status
		</div>
	...
	<div class="content_04-2 tc" style="background: url(resource/images/bg.jpg) no-repeat 0% 88%;">
   	 ...
   	 <iframe class="infra_iframe" src="http://ionm.yido.co.kr/iOnM/cctvView01_.html"  scrolling="no" frameborder="0"></iframe>
