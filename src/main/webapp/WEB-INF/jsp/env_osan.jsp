...
<div class="content_50" style="background: url(resource/images/bg.jpg) no-repeat 0% 0;"> 
	...
	<div class="wow fadeInUp" style="background: url(/resource/images/env/main_osan.jpg) no-repeat 100% 0%;width: 100%; height: 1000px; background-size: 100%;"></div> 
...
<div class="content_04">
	<div class="content_04-1">
		<div class="title_month">
			<i class="fas fa-circle-notch"></i> 오산소각장 2021년 11월 누적 Business Status
		</div>
	...
	<div class="content_04-2" style="background: url(resource/images/bg.jpg) no-repeat 0% 88%;">
		<!-- <img src="/resource/images/img_coming3.png"> -->
			...
			<iframe width="810" height="455" src="https://www.youtube.com/embed/c_QXq-Tr_oo?autoplay=1&mute=1"
