...
<div class="content_01">
	<div class="content_01-2 content01_golf_geumgang" >
		...
		<h2 class="tc colorwhite fs18 wow fadeInUp" style="margin-top: 15px; font-weight: bold;">18Hole / Par 72 (7,777yd)</h2>
	</div>
...
<div class="content_50">
	<div class="container tc" style="position: relative">
		...
		<!--일일현황보고서-->
		<div class="golfday_wrap  wow flipInX" style="left:inherit;right:3%">
			<div class="div_box">
				<div class="top_txt">
					<h1 class="colorwhite">
...
<div class="content_04" style="background: url(resource/images/bg.jpg) no-repeat 0 0">
	...
	<div class="content_04-2 tc" style="background: url(resource/images/bg.jpg) no-repeat 0% 88%;">
		...
		<iframe width="810" height="455" src="https://www.youtube.com/embed/SqhuknHGzT8?autoplay=1&mute=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	</div>
</div>
<!--//4번째컨텐츠-->
