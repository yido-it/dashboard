...
<div class="content_01">
	<div class="content_01-2 content01_infra_ulsan" >
		...
		<div class="tc mt50" style="font-size: 40px; color: #fff; font-weight: bold;">울산대교</div>
...
<div class="content_50" style="background: url(resource/images/bg.jpg) no-repeat 0% 0;"> 
	...
	<div style="background: url(/resource/images/infra/main_ulsan.jpg) no-repeat 100% 0%;width: 100%; height: 1000px; background-size: 100%;"></div> 
